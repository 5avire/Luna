...
namespace Luna {
    ...
    bool ImGuiLayer::OnKeyPressedEvent(KeyPressedEvent& e)
    {
        ...
        io.AddKeyEvent(ImGuiMod_Ctrl, ImGui::IsKeyDown(ImGuiKey_RightCtrl) || ImGui::IsKeyDown(ImGuiKey_LeftCtrl));
        io.AddKeyEvent(ImGuiMod_Alt, ImGui::IsKeyDown(ImGuiKey_RightAlt) || ImGui::IsKeyDown(ImGuiKey_LeftAlt));
        io.AddKeyEvent(ImGuiMod_Shift, ImGui::IsKeyDown(ImGuiKey_RightShift) || ImGui::IsKeyDown(ImGuiKey_LeftShift));
        io.AddKeyEvent(ImGuiMod_Super, ImGui::IsKeyDown(ImGuiKey_RightSuper) || ImGui::IsKeyDown(ImGuiKey_LeftSuper));
